...
import { menuHref, pageKeyFromPathname, ROUTES } from "@/lib/routes";
...
const SELF_HEADER_PAGES: PageKey[] = ["list", "reports", "detail", "edit"];
                ...
                actions={activePage !== "record" && activePage !== "settings" ? (
                  <>
                    {permissions.canExport && (
                      <button
                        onClick={activePage === "dashboard" ? onDashboardExport : () => router.push(ROUTES.reports)}
